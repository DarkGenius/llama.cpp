...
static const std::map<llm_arch, const char *> LLM_ARCH_NAMES = {
    ...
    { LLM_ARCH_KIMI_LINEAR,      "kimi_linear"      },
...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_MOE_INTERMEDIATE_SIZE,             "%s.moe_intermediate_size"             },
    { LLM_KV_ROUTED_SCALING_FACTOR,             "%s.routed_scaling_factor"             },
    ...
    { LLM_KV_ATTENTION_MLA_NOPE_ENABLED,             "%s.attention.mla_nope_enabled"             },
    { LLM_KV_ATTENTION_SHORT_CONV_KERNEL_SIZE,       "%s.attention.short_conv_kernel_size"       },
    { LLM_KV_ATTENTION_FULL_ATTENTION_LAYERS,        "%s.attention.full_attention_layers"        },
