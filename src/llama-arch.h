...
enum llm_kv {
    ...
    LLM_KV_MOE_INTERMEDIATE_SIZE,
    LLM_KV_ROUTED_SCALING_FACTOR,
    ...
    LLM_KV_ATTENTION_QK_NOPE_HEAD_DIM,
    LLM_KV_ATTENTION_QK_ROPE_HEAD_DIM,
    LLM_KV_ATTENTION_V_HEAD_DIM,
    LLM_KV_ATTENTION_MLA_NOPE_ENABLED,
    LLM_KV_ATTENTION_SHORT_CONV_KERNEL_SIZE,
    LLM_KV_ATTENTION_FULL_ATTENTION_LAYERS,
...
enum llm_tensor {
    ...
    // Kimi-Linear KDA (Kimi Delta Attention) tensors
    ...
    // Kimi-Linear MLA (Multi-head Latent Attention) tensors
    LLM_TENSOR_ATTN_KV_A_PROJ_MQA,
    LLM_TENSOR_ATTN_KV_B_PROJ,
    // Kimi-Linear MoE tensors
